...
bool cross_config_ = false, tf45_ = false, cov_pos_ = false, cov_vel_ = false,
     cov_color_ = false, origin_ = false, isOriginSet = false;
...
visualization_msgs::Marker velROS, covROS, covVelROS, trajROS, sensorROS,
    meshROS;
...
int main(int argc, char** argv) {
  ...
  cov_vel_pub_ = nh.advertise<visualization_msgs::Marker>("covariance_velocity",
                                                          100, true);
