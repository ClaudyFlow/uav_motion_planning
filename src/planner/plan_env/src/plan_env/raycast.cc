...
void Raycast(const Eigen::Vector3d& start, const Eigen::Vector3d& end,
  ...
  // Direction to increment x,y,z when stepping.
  int stepX = static_cast<int>(signum(static_cast<int>(dx)));
  int stepY = static_cast<int>(signum(static_cast<int>(dy)));
  int stepZ = static_cast<int>(signum(static_cast<int>(dz)));
...
bool RayCaster::setInput(const Eigen::Vector3d& start,
  ...
  // Direction to increment x,y,z when stepping.
  stepX_ = static_cast<int>(signum(static_cast<int>(dx_)));
  stepY_ = static_cast<int>(signum(static_cast<int>(dy_)));
  stepZ_ = static_cast<int>(signum(static_cast<int>(dz_)));
