...
void PolyTraj::addSegment(vector<double> cx, vector<double> cy,
                          vector<double> cz, double t) {
...
double PolyTraj::getTotalTIme() { return total_time; }
...
double PolyTraj::getMeanVel() { return length / total_time; }
